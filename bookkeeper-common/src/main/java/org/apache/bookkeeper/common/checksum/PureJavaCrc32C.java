 ...
 *
 * <p>A pure-java implementation of the CRC32 checksum that uses
 * the CRC32-C polynomial, the same polynomial used by iSCSI
 * and implemented on many Intel chipsets supporting SSE4.2.
 *
 * <p>The exact version that was retrieved from Hadoop:
 * {@link https://github.com/apache/hadoop/blob/224de4f92c222a7b915e9c5d6bdd1a4a3fcbcf31/hadoop-common-project/hadoop-common/src/main/java/org/apache/hadoop/util/PureJavaCrc32C.java}
 */
@Private
class PureJavaCrc32C implements Checksum {
    ...
    protected static final int T8_0_START = 0 * 256;
    protected static final int T8_1_START = 1 * 256;
    protected static final int T8_2_START = 2 * 256;
    protected static final int T8_3_START = 3 * 256;
    protected static final int T8_4_START = 4 * 256;
    protected static final int T8_5_START = 5 * 256;
    protected static final int T8_6_START = 6 * 256;
    protected static final int T8_7_START = 7 * 256;

    protected static final int[] T = new int[]{
        /* T8_0 */
