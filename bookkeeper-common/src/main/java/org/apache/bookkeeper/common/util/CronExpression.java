 ...
 *
 * <P>Parser for unix-like cron expressions: Cron expressions allow specifying combinations of criteria for time
 ...
 * </table>
 *
 * <P>'*' Can be used in all fields and means 'for all values'. E.g. &quot;*&quot; in minutes, means 'for all minutes'
 *
 * <P>'?' Can be used in Day-of-month and Day-of-week fields. Used to signify 'no special value'.
 * It is used when one want to specify something for one of those two fields, but not the other.
 *
 * <P>'-' Used to specify a time interval. E.g. &quot;10-12&quot; in Hours field means 'for hours 10, 11 and 12'
 *
 * <P>',' Used to specify multiple values for a field. E.g. &quot;MON,WED,FRI&quot; in Day-of-week field means &quot;for
 * monday, wednesday and friday&quot;
 *
 * <P>'/' Used to specify increments. E.g. &quot;0/15&quot; in Seconds field means &quot;for seconds 0, 15, 30, ad
 ...
 *
 * <P>'L' Can be used on Day-of-month and Day-of-week fields. It signifies last day of the set of allowed values. In
 ...
 * Holidays are not accounted for. &quot;15W&quot; in Day-of-Month field means 'closest weekday to 15 i in given month'.
 * If the 15th is a Saturday, it gives Friday. If 15th is a Sunday, the it gives following Monday.
 *
 * <P>'#' Can be used in Day-of-Week field. For example: &quot;5#3&quot;
 * means 'third friday in month' (day 5 = friday, #3 - the third).
 * If the day does not exist (e.g. &quot;5#5&quot; - 5th friday of month) and there aren't 5 fridays in
 * the month, then it won't match until the next month with 5 fridays.
 *
 * <P><b>Case-sensitive</b> No fields are case-sensitive
 *
 * <P><b>Dependencies between fields</b> Fields are always evaluated independently,
