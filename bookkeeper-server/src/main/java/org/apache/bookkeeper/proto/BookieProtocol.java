...
public interface BookieProtocol {
    ...
    public static final short FLAG_VOLATILE_DURABILITY = 0x0004;
    ...
    static class AddRequest extends Request {
        ...
        boolean isVolatileDurabilityAdd() {
            return (flags & FLAG_VOLATILE_DURABILITY) == FLAG_VOLATILE_DURABILITY;
        }
