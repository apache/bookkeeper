...
class AuthHandler {
    ...
    static class ServerSideHandler extends SimpleChannelHandler {
        ...
        static class AuthResponseCallbackLegacy implements GenericCallback<AuthToken> {
        ...
        static class AuthResponseCallback implements GenericCallback<AuthToken> {
    ...
    static class ClientSideHandler extends SimpleChannelHandler {
        ...
        class AuthRequestCallback implements GenericCallback<AuthToken> {
            Channel channel;
