 ...
 */
public final class ResolvedBookieSocketAddress extends BookieSocketAddress {
    ...
    public ResolvedBookieSocketAddress(String hostname, int port) {
    ...
    public ResolvedBookieSocketAddress(String addr) throws UnknownHostException {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ResolvedBookieSocketAddress)) {
            return false;
        }
        ResolvedBookieSocketAddress that = (ResolvedBookieSocketAddress) obj;
    ...
    public String getNameForMetrics() {
        return buildStatsLoggerScopeName(this);
    }
    
    public static String buildStatsLoggerScopeName(ResolvedBookieSocketAddress addr) {
    ...
    public static BookieAddressResolver DUMMY = (b) -> (ResolvedBookieSocketAddress) b;
}
