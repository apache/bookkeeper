...
public class LedgerMetadata {
    ...
    public LedgerMetadata(int ensembleSize, int writeQuorumSize, int ackQuorumSize,
        ...
        this.ledgerType = ledgerType.equals(LedgerType.FORCE_DEFERRED_ON_JOURNAL) ?
            DataFormats.LedgerType.FORCE_DEFERRED_ON_JOURNAL : DataFormats.LedgerType.FORCE_ON_JOURNAL;
    ...
    public LedgerMetadata(int ensembleSize, int writeQuorumSize, int ackQuorumSize,
        ...
        this(ensembleSize, writeQuorumSize, ackQuorumSize, digestType, password, null, LedgerType.FORCE_ON_JOURNAL);
    }
    ...
    @VisibleForTesting
    public DataFormats.LedgerType getLedgerType() {
        return ledgerType;
    }
    ...
    public byte[] serialize() {
        ...
        if (!ledgerType.equals(DataFormats.LedgerType.FORCE_ON_JOURNAL)) {
    ...
    public static LedgerMetadata parseConfig(byte[] bytes, Version version, Optional<Long> msCtime) throws IOException {
        ...
        if (data.hasLedgerType()) {
            ...
            lc.ledgerType = DataFormats.LedgerType.FORCE_ON_JOURNAL;
        }
