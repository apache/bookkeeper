...
import static org.apache.bookkeeper.proto.checksum.DigestType.fromBookKeeperDigestType;
...
public class LedgerHandle implements WriteHandle {
    ...
    LedgerHandle(BookKeeper bk, long ledgerId, LedgerMetadata metadata,
        ...
        macManager = DigestManager.instantiate(ledgerId, password, fromBookKeeperDigestType(digestType));
