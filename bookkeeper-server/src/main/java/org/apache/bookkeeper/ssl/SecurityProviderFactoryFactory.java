...
public abstract class SecurityProviderFactoryFactory {
    ...
    public static SecurityHandlerFactory getSecurityProviderFactory(String securityHandler, AbstractConfiguration conf)
        ...
        try {
            ...
            shFactory = (SecurityHandlerFactory) shFactoryClass.getConstructor(AbstractConfiguration.class)
                    .newInstance(conf);
