        ...
        try {
            if (HttpServer.Method.PUT == request.getMethod()) {
                ...
                if (requestBody == null || StringUtils.isEmpty(requestBody.trim())) {
                    ...
                    boolean forceMajor = Boolean.parseBoolean(configMap.getOrDefault("forceMajor", false).toString());
                    boolean forceMinor = Boolean.parseBoolean(configMap.getOrDefault("forceMinor", false).toString());
