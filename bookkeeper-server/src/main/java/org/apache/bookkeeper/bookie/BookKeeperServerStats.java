...
public interface BookKeeperServerStats {
    ...
    // BaseMetricMonitor Stats
    String BASE_METRIC_MONITOR_SCOPE = "base_metric_monitor";
    String JOURNAL_IO_UTIL = "JOURNAL_IO_UTIL";
    String LEDGER_IO_UTIL = "LEDGER_IO_UTIL";
    String CPU_USED_RATE = "CPU_USED_RATE";
    String WRITE_BYTES_PER_SECOND = "WRITE_BYTES_PER_SECOND";
}
