...
import static org.apache.bookkeeper.bookie.BookKeeperServerStats.JOURNAL_CB_QUEUE_LATENCY;
...
public class JournalStats {
    ...
    public JournalStats(StatsLogger statsLogger, final long maxJournalMemoryBytes,
        ...
        journalCbQueueLatency = statsLogger.getOpStatsLogger(BookKeeperServerStats.JOURNAL_CB_QUEUE_LATENCY);
