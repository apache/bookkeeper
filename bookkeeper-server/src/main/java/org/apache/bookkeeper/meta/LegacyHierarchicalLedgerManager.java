 ...
 */
class LegacyHierarchicalLedgerManager extends AbstractZkLedgerManager {
    ...
    protected boolean isSpecialZnode(String znode) {
        return IDGEN_ZNODE.equals(znode) || HierarchicalLedgerManager.IDGEN_ZNODE.equals(znode) || super.isSpecialZnode(znode);
    }
