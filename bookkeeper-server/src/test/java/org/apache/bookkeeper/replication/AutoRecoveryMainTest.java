...
public class AutoRecoveryMainTest extends BookKeeperClusterTestCase {
    ...
    public void testAutoRecoverySessionLoss() throws Exception {
        ...
        assertEquals("Current Auditor should be AR1", currentAuditor, Bookie.getBookieId(bsConfs.get(0)));
         ...
         */
        assertEquals("Current Auditor should still be AR1", currentAuditor, Bookie.getBookieId(bsConfs.get(0)));
        Awaitility.await().untilAsserted(() -> {
        ...
        assertEquals("Current Auditor should be AR3", currentAuditor, Bookie.getBookieId(bsConfs.get(2)));
        Awaitility.await().untilAsserted(() -> {
