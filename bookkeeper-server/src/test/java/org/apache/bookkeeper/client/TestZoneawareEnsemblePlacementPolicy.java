...
public class TestZoneawareEnsemblePlacementPolicy extends TestCase {
    ...
    public void testReplaceBookie() throws Exception {
         ...
         */
        PlacementResult<BookieId> replacePlacementResult = zepp.replaceBookie(6, 6, 2, null, ensemble, addr7,
                excludedBookies);
    ...
    public void testReplaceBookieMinUDs() throws Exception {
         ...
         * bookie in /zone3/ud2.
         */
        PlacementResult<BookieId> replaceResponse = zepp.replaceBookie(6, 6, 2, null, ensemble, addr4,
                excludedBookies);
    ...
    public void testReplaceBookieRandomly() throws Exception {
        ...
        PlacementResult<BookieId> replaceResponse = zepp.replaceBookie(4, 3, 2, null, ensembleList, addr3,
                excludeBookies);
