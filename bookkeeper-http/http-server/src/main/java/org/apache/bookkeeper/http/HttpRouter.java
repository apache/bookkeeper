...
public abstract class HttpRouter<Handler> {
    ...
    public static final String TRIGGER_GC                   = "/api/v1/bookie/trigger_gc";
    // autorecovery
    ...
    public HttpRouter(AbstractHttpHandlerFactory<Handler> handlerFactory) {
        ...
        this.endpointHandlers.put(TRIGGER_GC, handlerFactory.newHandler(HttpServer.ApiType.TRIGGER_GC));
