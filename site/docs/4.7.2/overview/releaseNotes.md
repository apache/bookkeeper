...
The 4.7.2 release is a bugfix release which fixes a bunch of issues reported from users of 4.7.0.

Apache BookKeeper users who are using 4.7.0 are encouraged to upgrade to 4.7.2. The technical details of this release are summarized
below.
...
- Various bug fixes and improvements around bookkeeper table service, see changes under [apache/bookkeeper#release/4.7.2](https://github.com/apache/bookkeeper/issues?utf8=%E2%9C%93&q=is%3Aclosed+label%3Aarea%2Ftableservice+label%3Arelease%2F4.7.1)
