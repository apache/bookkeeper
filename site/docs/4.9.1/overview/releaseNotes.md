...
The 4.9.1 release incorporates hundreds of bug fixes, improvements, and features since previous major release, 4.8.0,
which was released four months ago. It is a new milestone in Apache BookKeeper community.

Apache BookKeeper/DistributedLog users are encouraged to [upgrade to 4.9.1](../../admin/upgrade). The technical details of
this release are summarized below.

## Highlights

The main features in 4.9.1 cover are around following areas:
...
Here is a list of dependencies changed in 4.9.1:
...
There are multiple new client features introduced in 4.9.1. Here are two highlighted features:

- LedgerHandleAdv exposes `asyncAddEntry` variant that takes ByteBuf

### Configuration

There are bunch of new settings introduced in both bookie and client in 4.9.1. Here are those settings:
...
There are a few big changes around metadata in 4.9.1. They are:
...
Starting from 4.9.1, bookkeeper will release a python client for table service. See details at [#1691](https://github.com/apache/bookkeeper/pull/1691)
