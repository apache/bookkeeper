...
The 4.8.1 release incorporates hundreds of bug fixes, improvements, and features since previous major release, 4.7.0.
...
Apache BookKeeper/DistributedLog users are encouraged to [upgrade to 4.8.1](../../admin/upgrade). The technical details of
