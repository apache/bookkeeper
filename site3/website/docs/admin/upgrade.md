...
> If you have questions about upgrades (or need help), please feel free to reach out to us by [mailing list]({{ site.mailing_lists_url }}) or [Slack Channel]({{ site.slack_url }}).
