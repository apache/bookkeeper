...
/**
 * ListenableFuture-returning stub for StorageContainerService.
 *
 ...
 */
public final class StorageContainerServiceFutureStub extends AbstractStub<StorageContainerServiceFutureStub> {

    public static StorageContainerServiceFutureStub newFutureStub(Channel channel) {
        return new StorageContainerServiceFutureStub(channel, CallOptions.DEFAULT);
    }
    ...
    @Override
    protected StorageContainerServiceFutureStub build(Channel channel, CallOptions callOptions) {
        return new StorageContainerServiceFutureStub(channel, callOptions);
    }

    public ListenableFuture<GetStorageContainerEndpointResponse> getStorageContainerEndpoint(
            GetStorageContainerEndpointRequest request) {
        return ClientCalls.futureUnaryCall(
            getChannel().newCall(StorageContainerServiceGrpc.getGetStorageContainerEndpointMethod(), getCallOptions()),
            request);
    }
}
