...
import static org.apache.distributedlog.statestore.impl.kv.KVUtils.NOP_CMD;
import static org.apache.distributedlog.statestore.impl.kv.KVUtils.newCommand;
import static org.apache.distributedlog.statestore.impl.kv.KVUtils.newCommandBuf;
...
public class TestKVUtils {
    ...
    public void testNewLogRecordBuf() throws Exception {
        ...
        @Cleanup("release") ByteBuf buffer = newCommandBuf(command);
